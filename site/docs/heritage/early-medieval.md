---
title: "Early Medieval Two Mile Borris (AD 450 – 1169)"
---
...
The early medieval finds at the M8 site sit near the top of a gentle south-east-facing slope with wide views across the valley. Three phases of enclosure (called Enclosures A, B and C by the dig team) were identified, one replacing or growing out of another over centuries.
...
<div class="finding-meta">Fifth or sixth century, ditch radiocarbon-dated AD 400–560</div>

The first enclosure on the site was an unusual oval shape, with one straight or slightly indented side, that the excavators compared to the shape of a guitar plectrum. It measured 42 metres at its widest. The ditch was U-shaped in profile, around a metre wide and two-thirds of a metre deep on average, with the digging slightly more substantial near the entrance.
...
Inside, a circular timber structure 5.5 metres across, and 27 pits scattered through the interior used for hearths, storage and roasting. Finds from the ditch and pits include a handle made from red deer antler, a ceramic crucible for melting metal, iron-working residues, and 90 kg of animal bone.
</div>
...
<div class="finding-meta">Seventh or eighth century, ditch radiocarbon-dated AD 677–774</div>
...
Inside the ringfort, four circular structures, defined by post-holes and (in two cases) shallow curving gullies. From the ditch came several iron knives, a fragment of a quern-stone for grinding grain, a glass bead, a stone gaming-board, and 26 kg of animal bone.

The dating sits squarely within the main ringfort era of seventh to ninth century Ireland.
</div>
...
<div class="finding-meta">Later phase, reusing the ringfort as part of a larger enclosure</div>
...
Inside Enclosure C the dig found an iron furnace, a smithing hearth, two cereal-drying kilns, several pits, a four-post structure (probably a granary), and two more circular buildings. Plus two more iron knives, metallurgical residues, and another 76 kg of animal bone.
...
Twenty burials were identified inside the abandoned ditch line of the original plectrum enclosure (B), with some additional disarticulated skeletal material. The dead were arranged east-to-west in shallow unlined graves, which is characteristic of the period:

- 11 adults
- 1 adolescent
- 8 juveniles
- 14 lying flat (extended)
- 2 with knees drawn up (flexed)
- 2 in crouched positions

One adult woman had been buried with a copper-alloy ring-pin tucked beneath the vertebrae of her neck. Whether that was a brooch fastening her clothing for burial, or a personal possession placed with her, is hard to know.

The interesting thing is the *closeness*: the burials sit right beside the working ringfort. People in this period clearly didn't see a hard line between the living and the dead. The dead stayed part of the community. Burial within the settlement, rather than in a separate consecrated graveyard, is now recognised as a much more widespread early medieval practice than it used to be.
...
<div class="heritage-nav" markdown="0">
  <a href="../prehistoric/">
    ...
    <span class="nav-title">Prehistoric (5500 BC – AD 450)</span>
  </a>
  <a href="../medieval/" class="nav-next">
    <span class="nav-label">Next era →</span>
    <span class="nav-title">Medieval (AD 1169 – 1550)</span>
  </a>
</div>
