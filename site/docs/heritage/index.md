...
<div class="heritage-timeline" markdown="0">
  <a href="prehistoric/" class="era era-prehistoric">
    <span class="era-name">Prehistoric</span>
    <span class="era-dates">5500 BC – AD 450</span>
  </a>
  <a href="early-medieval/" class="era era-early-medieval">
    <span class="era-name">Early Medieval</span>
    <span class="era-dates">AD 450 – 1169</span>
  </a>
  <a href="medieval/" class="era era-medieval">
    <span class="era-name">Medieval</span>
    <span class="era-dates">AD 1169 – 1550</span>
  </a>
  <a href="modern/" class="era era-modern">
    <span class="era-name">Modern</span>
    <span class="era-dates">1550 – today</span>
  </a>
</div>
...
=== "Early Medieval"
    ...
    A "plectrum-shaped" stockaded enclosure built in the fifth or sixth century, with a defended entrance and a palisade. It fell out of use, and a classic ringfort was raised over the top of it in the seventh or eighth. Inside the ringfort, four roundhouses, including one whose dimensions match a house type described in the Críth Gabhlach, an early Irish law-tract. Iron knives, a glass bead, a stone gaming-board, a crucible for metalworking. And, just outside, a small cemetery of 20 burials, family and neighbours laid to rest right beside the settlement.

    [Read more about early medieval Two Mile Borris →](early-medieval.md)
...
=== "Modern"
    ...
    The borough faded into a country village. The castle changed hands and finally became the picturesque ruin we have today. The parish church of St James anchored the village. In 1900, the Two Mile Borris hurlers represented Tipperary in the All-Ireland Final at Jones' Road in Dublin and beat London 2-5 to 0-6, and a centennial monument at the heart of the village marks it. Today the village is small but stitched-together: a primary school named after St Mochoemog, a tight set of community groups, and a tidy towns committee writing the next chapter.

    [Read more about modern Two Mile Borris →](modern.md)

## Where to find it on the ground

A lot of this story is invisible from the road, ploughed flat or buried under topsoil. Some of it you can still see and walk around:

- **[Blackcastle](../places/blackcastle.md)** on the western approach is the upstanding ruin of the 12th century Norman castle. Most visible piece of medieval Two Mile Borris.
- **[Liathmore Monastic Site](../places/liathmore.md)** about 2km east is the early medieval monastery founded by St Mochoemog, with two ruined churches and the foundation of an ancient round tower.
- **[The Monument Area](../places/monument.md)** at the village centre carries the 1900 All-Ireland Hurling Centennial monument, with the names of the winning panel.
- **[The Bog Walk Loop](../places/bog_walk.md)** out the back of the village skirts the wetlands that gave us the Iron Age shield from Clonoura and the Newhill bog body, both found within 5km of here.
- **[The Village Map](../map.md)** ties them together.
...
- [National Monuments Service Historic Environment Viewer](https://maps.archaeology.ie/HistoricEnvironment/) for the wider archaeological record around the village.
- [Townlands.ie: Borris townland, Twomileborris](https://www.townlands.ie/tipperary/eliogarty/twomileborris/twomileborris/borris/) for the boundaries and history of the townland the dig was in.
- [Wikipedia: Two-Mile Borris](https://en.wikipedia.org/wiki/Two-Mile_Borris) for an overview.

---

*This Heritage section is being written and updated by the Tidy Towns committee. If you have local memories, photographs, or research that should be on these pages, [drop us a line](mailto:info@tmbvillage.ie).*
