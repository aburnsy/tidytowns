...
def find_edge() -> Path:
    ...
    if found:
        return Path(found)
    raise SystemExit("ERROR: Microsoft Edge not found. Install Edge or adjust EDGE_CANDIDATES.")
...
def html_to_pdf(edge: Path, html: str, dst: Path):
